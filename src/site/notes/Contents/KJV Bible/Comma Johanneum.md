---
{"dg-publish":true,"permalink":"/contents/kjv-bible/comma-johanneum/","noteIcon":"","created":"2026-07-31T01:44:55.023+08:00","dg-note-properties":{"aliases":null}}
---

![Pasted image 20260731003702.png\|400](/img/user/Attachments/Pasted%20image%2020260731003702.png)

> [!bible]+ [1 John 5:7-8 - KJV](https://www.biblegateway.com/passage/?search=1+John+5:7-8&version=kjv)
...
Here is how the passage compares across different major translation families.

# 1. Translations That INCLUDE The Comma

These Bibles are based on the _Textus Receptus_ (a Greek text compiled in the 1500s) or the Latin Vulgate. In these versions, the text includes an explicit reference to the Trinity.
...
Modern translations are based on "Critical Texts" (like the Nestle-Aland or United Bible Societies editions). These scholars rely on the oldest and earliest discovered Greek manuscripts. In these Bibles, the Trinitarian clause is absent from the main text (though usually noted in a footnote), making the passage much shorter.
...
The discrepancy comes down to a difference in ancient manuscripts.

**The Early Greek Manuscripts:**

The explicit Trinitarian wording ("the Father, the Word, and the Holy Ghost...") is not found in any of the oldest Greek manuscripts of the New Testament. In fact, it doesn't appear in _any_ Greek manuscript before the 14th century, except as a note scribbled in the margins. Because of this, modern translators overwhelmingly agree that the Apostle John did not originally write these words.
...
✅ First and Second Editions:  1516 & 1519

>Erasmus published his first Greek New Testament in 1516, and a revised edition in 1519. In both, he left out the Comma Johanneum. He noted that he simply translated what was in the Greek texts, none of which contained the Trinitarian verse.

✅ Fierce Backlash: 1519–1521

>Erasmus faced intense fire from Catholic theologians, most notably Lopez de Zúñiga (Stunica) and Edward Lee. Because the verse was in the Latin Vulgate (the official Bible of the Church), they accused Erasmus of tampering with scripture and secretly promoting Arianism (the denial of the Trinity).

✅ The 'Discovered' Manuscript: 1522

>To appease his critics, Erasmus included the verse in his third edition. His justification was that a single Greek manuscript containing the verse had finally been presented to him: **Codex Montfortianus** (also known as Minuscule 61).
...
- [[Contents/KJV Bible/Origin, Transmission, Canonization of OT\|Origin, Transmission, Canonization of OT]]